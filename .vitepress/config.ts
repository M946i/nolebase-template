...
import { EndGenerateOpenGraphImages } from '@nolebase/vitepress-plugin-og-image/vitepress'
...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      copyright:
        '<a class="footer-cc-link" target="_blank" href="https://vercel.com">deployed by vercel</a> © 2024 - 至今',
    },
    search: {
      provider: 'local',
      options: {
  ...
  async End(siteConfig) {
    await EndGenerateOpenGraphImages({
